...
<div class="container-fluid">
  ...
  <div class="row">
    ...
    <form id="buyer-update-form" action="<?php echo e(route('frontBuyerProfileUpdate')); ?>" method="post"  enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
      <div class="col-md-6">
        <h2><?php echo e($registertype); ?> <?php echo e(__('users.profile_update_title')); ?></h2>
        ...
        <div class="login_box">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control login_input" name="phone_number" id="phone_number" placeholder="<?php echo e(__('users.phone_number_label')); ?>" value="<?php echo e((old('phone_number')) ? old('phone_number') : $buyerDetails[0]->phone_number); ?>">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control login_input" name="city" id="city" placeholder="<?php echo e(__('users.city_label')); ?>" value="<?php echo e((old('city')) ? old('city') : $buyerDetails[0]->city); ?>">
       ...
       <div class="col-md-6">
        ...
        <div class="login_box">
          ...
          <div class="form-group increment cloned">
            <label><?php echo e(__('users.profile_label')); ?></label>
            <?php
            ...
            <button class="uploadbtn"><i class="fa fa-upload" aria-hidden="true"></i> <?php echo e(__('users.upload_file_input')); ?></button>
            <input type="file" name="profile" class="form-control" value="<?php echo e(old('profile')); ?>" />
            </div>
