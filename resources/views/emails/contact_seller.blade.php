    ...
    <tr>
      <td><table width="100%" border="0" cellspacing="0" cellpadding="0" style="max-width:630px; margin:0 auto; padding:0 15px;">
          <tbody>
           ...
           <tr>
                <td style="text-align:center;"><h2 style="color:#000; font-size:26px; line-height:36px; margin-top: 40px;">{{ __('lang.hi')}} {{$seller_name}}!</h2></td>
              </tr>
              <tr>
                <td style="text-align:center;"><p style="margin:17px 0 35px 0;font-weight:600;color:#03989e;">Message from Buyer. Below are the details : </p></td>
              </tr>
              <tr>
                <td>Name : {{ $name }}</td>
              </tr>
