          ...
          <div class="carousel-inner home-slider" role="listbox">
            ...
            <div class="item active slider_item">
              ...
              <div class="item slider_item">
                <?php endif; ?>
                <img class="img-fluid" src="<?php echo e(url('/')); ?>/uploads/Slider/<?php echo $data['sliderImage']; ?>" id="sliderImages" alt="First slide">
        ...
        <div class="col-md-12">             
                ...
                <div class="loader"></div>
                    <!-- <h4><?php echo e(__('lang.popular_items_in_market_head')); ?></h4> -->
                     ...
                     <div>
                        <h2 class="product_heading"><?php echo e(__('lang.popular_product_head')); ?></h2> 
      ...
      <div class="row">
       <div class="product_view">
        <div class="col-md-12">             
                ...
                <div class="loader"></div>
                    <div >
                    <h2 class="product_heading"><?php echo e(__('lang.popular_services_head')); ?></h2>     
    ...
    <div class="col-md-12">             
        ...
        <div class="loader"></div>
          <div class="tj-prodhead-block">
            <h2 class="product_heading"><?php echo e(__('lang.feature_product_head')); ?></h2>
			...
			*/?>
            ...
            <div class="col-md-12 pl-w-0 pr-w-0">
				<div class="best_seller_container">
					...
					<h2 class="product_heading instagram_heading"><?php echo e(__('lang.instagram_label')); ?></h2>
...
<?php echo $__env->make('Front.layout.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\tijara\resources\views/Front/home.blade.php ENDPATH**/ ?>