...
<head>
  ...
  <link rel="icon" type="image/png" href="{{url('/')}}/assets/icon/favicon-32x32.png">
  <link rel="apple-touch-icon" href="{{url('/')}}/assets/icon/apple-touch-icon.png">
  ...
  <link rel="stylesheet" href="{{url('/')}}/assets/css/jquery-eu-cookie-law-popup.css">
...
.eupopup-button_1
{
  ...
  <script type="text/javascript"> 
    ...
    var select_one_shipping_option ="{{ __('errors.select_one_shipping_option')}}";
     var check_checkbox_first_err ="{{ __('errors.check_checkbox_first_err')}}";
  ...
  <script src="{{url('/')}}/assets/js/jquery-eu-cookie-law-popup.js"></script>
        ...
        @endphp
                    ...
                    <img  src="{{url('/')}}/assets/img/imgpsh_fullsize.png"  />
                      ...
                      <div class="cart_count notification_count">
                        ...
                        <span class="notification_count dropdown-toggle"  type="button" data-toggle="dropdown" id="notification_count" >{{$totalNotifications}}</span>
            <ul class="dropdown-menu">
        <li style="width:100%"><a href="{{route('frontAllbookingRequest')}}">{{ __('users.my_booking_title')}} <p class='badge badge-pill debg_color' id="allSellerBookings">{{ $getTotalBookings}}</p></a></li>
...
@endif 
  ...
  <script type="text/javascript">
		$(document).euCookieLawPopup().init({
		  cookiePolicyUrl : '{{url("/")}}/page/villkor',
