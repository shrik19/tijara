            ...
            <div class="login_box">
               ...
               <div class="col-md-6">
                   ...
                   <textarea class="login_input form-control" name="description" placeholder="{{ __('lang.product_description_label')}}" value="" tabindex="2" rows="5" cols="20">{{old('description')}}</textarea>
                    ...
                    <div style="display:none;" class="form-group  col-md-6" >
                    <label class="col-md-12 label_css p-0" >{{ __('lang.weight_label')}} <span class="de_col"></span></label>
              ...
              <label class="col-md-12 label_css p-0" class="col-md-6">{{ __('lang.product_slug_label')}} <span class="de_col">*</span></label>
              ...
              <div class="form-group  col-md-6" style="display:none;">
              <label class="col-md-12 label_css p-0" style="margin-bottom: 15px;">{{ __('lang.status_label')}} </label>
