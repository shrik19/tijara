        ...
        <div class="col-md-12">
          ...
          <div class="login_box">
              ...
              <div class="form-group col-md-12">
                ...
                <input type="text" class="col-md-8 login_input" name="title" id="title" placeholder="{{ __('servicelang.service_title_label')}} " value="{{old('title')}}" tabindex="1" onblur="checkServiceUniqueSlugName();">
              ...
              <div class="form-group col-md-12" style="display:none;">
                ...
                <input type="text" class="col-md-8 login_input slug-name" name="service_slug" id="service_slug" placeholder="{{ __('servicelang.service_slug_label')}} " value="{{old('service_slug')}}" tabindex="1" readonly="readonly">
              ...
              <div class="form-group col-md-8">
                  <textarea class="col-md-12 login_input" name="description" id="description" placeholder="{{ __('lang.service_description_label')}}" value="" tabindex="2">{{old('description')}}</textarea>
              ...
              <div class="form-group col-md-12">
                  ...
                  <input type="tel" class="number col-md-8 service_price" name="service_price" id="service_price" placeholder="{{ __('lang.service_price')}}" value="{{(old('service_price')) ?  old('service_price') :''}}" tabindex="7">
