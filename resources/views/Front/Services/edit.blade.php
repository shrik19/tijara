	  ...
	  @endif
		<div class="row">
		 <div class="col-md-2 tijara-sidebar" id="tjfilter">
		  ...
		  <div class="col-md-10 tijara-content tj-alignment"> @include ('Front.alert_messages') <div class="seller_info">
    ...
    <form id="service-form service-add-form" class="tijara-form" action="{{route('frontServiceStore')}}" method="post" enctype="multipart/form-data"> @csrf <div class="col-md-12 tjd-serviceform">
        <div class="col-md-12 text-right" style="margin-top:30px;">
          <a href="{{route('manageFrontServices')}}" title="" class="de_col">
            <span>
              <i class="fa fa-arrow-left" aria-hidden="true"></i>&nbsp;{{ __('lang.back_to_list_label')}}
            </span>
          </a>
        </div>
        <div class="login_box">
          ...
          <div class="form-group">
            <label class="col-md-3 product_table_heading">{{ __('servicelang.service_title_label')}}
              <span class="de_col">*</span>
            </label>
            <div class="col-md-8">
              <input type="text" class="col-md-8 login_input form-control" name="title" id="title" placeholder="{{ __('servicelang.service_title_label')}} " value="{{ (old('title')) ?  old('title') : $service->title}}" tabindex="1" onblur="checkServiceUniqueSlugName();">
              <span class="invalid-feedback col-md-8" id="err_title">@if($errors->has('title')) {{ $errors->first('title') }}@endif </span>
            </div>
          </div>
          <div class="form-group" style="display:none;">
            <label class="col-md-3 product_table_heading">{{ __('servicelang.service_slug_label')}}
              <span class="de_col">*</span>
            </label>
            <div class="col-md-8">
          ...
          <div class="form-group">
            <label class="col-md-3 product_table_heading">{{ __('servicelang.session_time_label')}}
              <span class="de_col">*</span>
            </label>
            <div class="col-md-8">
              <input maxlength="3" type="text" class="col-md-8 login_input session_time number form-control" name="session_time" id="session_time" placeholder="{{ __('servicelang.session_time_placeholder')}} " value="{{ (old('session_time')) ?  old('session_time') : $service->session_time}}" tabindex="1">
          ...
          <div class="form-group">
            <label class="col-md-3 product_table_heading">{{ __('users.address_label')}}
              <span class="de_col">*</span>
            </label>
            <div class="col-md-8">
              <input type="text" class="col-md-8 login_input address form-control" name="address" id="address" placeholder="{{ __('users.service_address_placeholder')}} " value="{{ (old('address')) ?  old('address') : $service->address}}" tabindex="1">
              <span class="invalid-feedback col-md-8address-err" id="address_err">@if($errors->has('address')) {{ $errors->first('address') }}@endif </span>
            </div>
          </div>
          <div class="form-group">
            <label class="col-md-3 product_table_heading">{{ __('lang.product_buyer_phone_no')}}
              <span class="de_col">*</span>
            </label>
            <div class="col-md-8">
              <input type="text" class="col-md-8 login_input telephone_number form-control" name="telephone_number" id="telephone_number" placeholder="{{ __('lang.product_buyer_phone_no')}} " value="{{ (old('telephone_number')) ?  old('telephone_number') : $service->telephone_number}}" tabindex="1">
          ...
          <div class="form-group">
            <label class="col-md-3 product_table_heading">{{ __('servicelang.service_description_label')}}
              <span class="de_col">*</span>
              <span class="de_col"></span>
            </label>
            <div class="col-md-8">
              <textarea class="col-md-12 login_input form-control description" name="description" rows="5" cols="5" placeholder="{{ __('users.service_description_placeholder')}}" value="" tabindex="2">{{ (old('description')) ?  old('description') : $service->description}}</textarea>
          ...
          <div class="form-group producterrDiv">
            <label class="col-md-3 product_table_heading">{{ __('lang.category_label')}}
              <span class="de_col">*</span>
            </label>
            <div class="col-md-8">
              <select class="select2 col-md-8 login_input form-control tjselect" name="categories[]" id="categories" multiple placeholder="{{__('lang.category_label')}}" tabindex="3">
                <option></option> @foreach($categories as $cat_id=>$category) <optgroup label="{{$category['maincategory']}}">
                  <!--<option value="{{$cat_id}}">{{$category['maincategory']}}</option>--> @foreach($category['subcategories'] as $subcat_id=>$subcategory) @if(in_array($subcat_id,$selectedCategories)) <option selected="selected" value="{{$subcat_id}}">{{$subcategory}}</option> @else <option value="{{$subcat_id}}">{{$subcategory}}</option> @endif @endforeach
                </optgroup> @endforeach
              </select>
          ...
          <div class="form-group" style="display:none;">
            <label class="col-md-3 product_table_heading">{{ __('lang.sort_order_label')}}
              <span class="de_col"></span>
            </label>
            <div class="col-md-8">
              <input type="text" class="col-md-8 login_input form-control" name="sort_order" id="sort_order" placeholder="{{ __('lang.sort_order_label')}}" value="{{(old('sort_order')) ?  old('sort_order') : $service->sort_order}}" tabindex="7">
              <span class="invalid-feedback col-md-8" id="err_meta_keyword">@if($errors->has('sort_order')) {{ $errors->first('sort_order') }}@endif </span>
            </div>
          </div>
          <div class="form-group producterrDiv">
            <label class="col-md-3 product_table_heading">{{ __('lang.status_label')}}
              <span class="de_col">*</span>
            </label>
            <div class="col-md-8">
          ...
          <div class="form-group">
            <label class="col-md-3 product_table_heading">{{ __('lang.service_price')}}
              <span class="de_col">*</span>
            </label>
            <div class="col-md-8">
              <input type="text" class="number col-md-8 service_price form-control" name="service_price" id="service_price" placeholder="{{ __('users.service_price_placeholder')}}" value="{{(old('service_price')) ?  old('service_price') : $service->service_price}}" tabindex="7">
          ...
          <div class="form-group">
            <label class="col-md-3 product_table_heading">{{ __('lang.images')}}
              <span class="de_col">*</span>
            </label>
            <div class="col-md-8">
              <div class="images col-md-12"> @php $images = explode(',',$service->images); @endphp @if(!empty($images)) @foreach($images as $image) @if($image!='') <div>
                ...
                <div class="row">
                  <div class="form-group col-md-3 producterrDiv">
                    ...
                    <select class="col-md-12 service_year form-control tjselect" name="service_year" id="service_year">
                      <option value="">{{ __('lang.select_label')}}</option> <?php
                                             for($i=date('Y'); $i<'2050';$i++) {
                                             ?> <option value="
																							<?php echo $i; ?>"> <?php echo $i; ?> </option> <?php
                                             }
                                             ?>
                    </select>
                  ...
                  <div class="form-group col-md-3 producterrDiv">
                    ...
                    <select class="col-md-12 service_month form-control tjselect" name="service_month" id="service_month">
                      <option value="">{{ __('lang.select_label')}}</option> <?php
                                             ...
                                             ?> <option value="
																							<?php echo date('m', strtotime($timestamp)); ?>"> <?php echo date('F', strtotime($timestamp)); ?> </option> <?php
                                             }
                                             ?>
                    </select>
                  ...
                  <div class="form-group col-md-2 producterrDiv">
                    ...
                    <span style="" class="invalid-feedback col-md-12" id="start_time"> @if($errors->has('service_availability')) {{ $errors->first('service_availability') }}@endif </span>
        ...
        <div class="col-md-12">
          ...
          <div class="col-md-6">
            <div class="col-md-3 tj-editaction" style="margin-left: 200px;display: flex;">
              <a href="javascript:void(0);" name="remove_service_date" id="remove_service_date" class="btn btn-danger login_btn save_service_date" tabindex="9" val="delete">{{ __('lang.remove_title')}}</a> &nbsp;&nbsp; <a href="javascript:void(0);" name="save_service_date" id="save_service_date" class="btn debg_color login_btn save_service_date" tabindex="9" val="insert">{{ __('lang.save_service_date_btn')}}</a>
            </div>
            <div class="col-md-3"></div>
          </div>
        </div>
        <div class="added_service_times" style="display:none;"> @if(!empty($serviceAvailability)) @foreach($serviceAvailability as $availability) @php $service_time = $availability['service_date'].' '.$availability['start_time']; @endphp <input type="hidden" id="{{$availability['id']}}" class="form-control service_availability " value="{{$service_time}}" name="service_availability[]"> @endforeach @endif </div>
