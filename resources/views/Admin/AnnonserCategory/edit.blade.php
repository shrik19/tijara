...
<div class="section-body">
   ...
   <p class="section-lead">{{ __('users.edit_annonser_cat_details_info')}}</p>
   <form method="POST" action="{{route('adminAnnonserCatUpdate', $id)}}" class="needs-validation" novalidate="">
   @csrf
   <div class="row">
