                  ...
                  <div class="col-md-12">
                    ...
                    <div class="login_box">
                        ...
                        <div class="form-group col-md-6">
                          ...
                          <input type="text" required class="login_input form-control" name="user_name" id="user_name" placeholder="<?php echo e(__('lang.product_buyer_name')); ?> " value="<?php if(isset($buyerProduct->user_name)): ?> <?php echo e($buyerProduct->user_name); ?> <?php else: ?> <?php echo e(old('user_name')); ?> <?php endif; ?>" tabindex="1">
                        ...
                        <div class="form-group col-md-6">
                          ...
                          <input type="email" required class="login_input form-control email" name="user_email" id="user_email" placeholder="<?php echo e(__('lang.product_buyer_email')); ?> " value="<?php if(isset($buyerProduct->user_email)): ?> <?php echo e($buyerProduct->user_email); ?> <?php else: ?> <?php echo e(old('user_email')); ?> <?php endif; ?>" tabindex="1" >
                        ...
                        <div class="form-group col-md-6">
                          ...
                          <input type="tel" required class="login_input form-control telphone" name="user_phone_no" id="user_phone_no" placeholder="<?php echo e(__('lang.product_buyer_phone_no')); ?> " value="<?php if(isset($buyerProduct->user_phone_no)): ?> <?php echo e($buyerProduct->user_phone_no); ?> <?php else: ?> <?php echo e(old('user_phone_no')); ?> <?php endif; ?>" tabindex="1">
                        ...
                        <div class="form-group col-md-6">
                          ...
                          <input type="text" class="login_input form-control" name="country" id="country" placeholder="<?php echo e(__('lang.product_country')); ?> " value="<?php if(isset($buyerProduct->country)): ?> <?php echo e($buyerProduct->country); ?> <?php else: ?> <?php echo e(old('country')); ?> <?php endif; ?>" tabindex="1">
                        ...
                        <div class="form-group col-md-6">
                          ...
                          <input type="text" class="login_input form-control" name="location" id="location" placeholder="<?php echo e(__('lang.product_location')); ?> " value="<?php if(isset($buyerProduct->location)): ?> <?php echo e($buyerProduct->location); ?> <?php else: ?> <?php echo e(old('location')); ?> <?php endif; ?>" tabindex="1">
                        ...
                        <div class="form-group col-md-6">
                          ...
                          <input type="text" class="form-control login_input" name="title" id="title" placeholder="<?php echo e(__('lang.product_title_label')); ?> " value="<?php echo e((old('title')) ?  old('title') : $product->title); ?>" tabindex="1" onblur="convertToSlug(this)">
                        ...
                        <div class="form-group col-md-6" >
                          ...
                          <input type="text" class="form-control login_input" name="meta_title" id="meta_title" placeholder="<?php echo e(__('lang.meta_title_label')); ?>" value="<?php echo e((old('meta_title')) ?  old('meta_title') : $product->meta_title); ?>" tabindex="4">
                        ...
                        <div class="form-group col-md-6">
                          ...
                          <input type="text" class="form-control login_input" name="meta_description" id="meta_description" placeholder="<?php echo e(__('lang.meta_desc_label')); ?>" value="<?php echo e((old('meta_description')) ?  old('meta_description') : $product->meta_description); ?>" tabindex="5">
                        ...
                        <div class="form-group col-md-6">
                          ...
                          <input type="text" class="form-control login_input" name="meta_keyword" id="meta_keyword" placeholder="<?php echo e(__('lang.meta_keyword_label')); ?>" value="<?php echo e((old('meta_keyword')) ?  old('meta_keyword') : $product->meta_keyword); ?>" tabindex="6">
                        ...
                        <div class="form-group col-md-6">
                          <label class="col-md-12"><?php echo e(__('lang.product_discount_label')); ?> <span class="de_col">*</span></label>
                          <input type="text" class="form-control login_input number" name="discount" id="discount" placeholder="<?php echo e(__('lang.product_discount_label')); ?> " value="<?php echo e((old('discount')) ?  old('discount') : $product->discount); ?>" tabindex="1">
                        ...
                        <div class="form-group  col-md-6"  style="display:none;">
                          ...
                          <input type="tel" class="form-control login_input" name="sort_order" id="sort_order" placeholder="<?php echo e(__('lang.sort_order_label')); ?>" value="<?php echo e((old('sort_order')) ?  old('sort_order') : $product->sort_order); ?>" tabindex="7">
                        ...
                        <div class="form-group col-md-6">
                          ...
                          <select class="select2 form-control login_input" name="categories[]" id="categories" multiple placeholder="<?php echo e(__('lang.category_label')); ?>" tabindex="3">
                          <option></option>
                              ...
                              <?php $v++; ?>
                                ...
                                <div class="variant_tr" id="variant_tr" variant_id="<?php echo $i;?>">
                                  ...
                                  <div style="display:none;" class="form-group  col-md-6" >
                                    ...
                                    <input type="text" class="form-control login_input sku variant_field" name="sku[<?php echo $i;?>]"  placeholder="<?php echo e(__('lang.sku_placeholder')); ?>" value="<?php echo e($variant['sku']); ?>" tabindex="7">
                                  ...
                                  <div style="display:none;" class="form-group  col-md-6" >
                                    ...
                                    <input type="text" class="form-control login_input weight variant_field" name="weight[<?php echo $i;?>]"  placeholder="<?php echo e(__('lang.weight_placeholder')); ?>" value="<?php echo e($variant['weight']); ?>" tabindex="7">
                                    <span class="invalid-feedback col-md-12" style="text-align: center;"  id="err_sku" ></span>
                                  </div>
                                  <div class="form-group  col-md-6" >
                                    <label class="col-md-12"><?php echo e(__('lang.price_label')); ?> <span class="de_col"></span></label>
                                    <input type="tel" class="form-control login_input price number variant_field" name="price[<?php echo $i;?>]"  placeholder="<?php echo e(__('lang.price_placeholder')); ?>" value="<?php echo e($variant['price']); ?>" tabindex="7">
                                    <span class="invalid-feedback col-md-12" style="text-align: center;"  id="err_sku" ></span>
                                  </div>
                                  <div style="display:none;" class="form-group  col-md-6" >
                                    <label class="col-md-12"><?php echo e(__('lang.qty_label')); ?> <span class="de_col"></span></label>
                                    <input type="tel" class="form-control login_input quantity number variant_field" name="quantity[<?php echo $i;?>]"  placeholder="<?php echo e(__('lang.qty_label')); ?>" value="<?php echo e($variant['quantity']); ?>" tabindex="7">
                                    <span class="invalid-feedback col-md-12" style="text-align: center;"  id="err_sku" ></span>
                                  </div>
                                  <div style="display:none;" class="form-group  col-md-6" >
                                  ...
                                  <div class="form-group  col-md-6" >
                                    ...
                                    <input type="file" variant_id="<?php echo $i; ?>" class="form-control login_input image  variant_image " name="image[<?php echo $i;?>]"  placeholder="<?php echo e(__('lang.image_label')); ?>" value='<?php echo e(old("image.$i")); ?>' tabindex="7">
                        ...
                        <div class="form-group col-md-12">
                          <textarea class="form-control login_input" name="description" id="description" placeholder="<?php echo e(__('lang.product_description_label')); ?>" value="" tabindex="2"><?php echo e((old('description')) ?  old('description') : $product->description); ?></textarea>
...
<?php echo $__env->make('Front.layout.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\tijara\resources\views/Front/Products/buyer-edit.blade.php ENDPATH**/ ?>