...
<div class="section-body">
   ...
   <p class="section-lead">Edit Product Category details.</p>
   ...
   <div class="row">
	  ...
	  <div class="col-12">
            ...
            <a href="{{route('adminCategory')}}" class="btn btn-icon icon-left btn-danger" tabindex="16"><i class="fas fa-times"></i> Cancel</a>
         </div>
   </div>
   </form>
</div>
