        ...
        <div class="col-md-12">
          ...
          <div class="login_box">
              ...
              <div class="form-group col-md-12">
                ...
                <input type="text" class="col-md-8 login_input" name="title" id="title" placeholder="<?php echo e(__('servicelang.service_title_label')); ?> " value="<?php echo e(old('title')); ?>" tabindex="1" onblur="checkServiceUniqueSlugName();">
              ...
              <div class="form-group col-md-12" style="display:none;">
                ...
                <input type="text" class="col-md-8 login_input slug-name" name="service_slug" id="service_slug" placeholder="<?php echo e(__('servicelang.service_slug_label')); ?> " value="<?php echo e(old('service_slug')); ?>" tabindex="1" readonly="readonly">
              ...
              <div class="form-group col-md-12" >
                ...
                placeholder="<?php echo e(__('servicelang.session_time_placeholder')); ?> " value="<?php echo e(old('session_time')); ?>" 
                tabindex="1" >
              ...
              <div class="form-group col-md-8">
                  <textarea class="col-md-12 login_input" name="description" id="description" placeholder="<?php echo e(__('lang.service_description_label')); ?>" value="" tabindex="2"><?php echo e(old('description')); ?></textarea>
              ...
              <div class="form-group col-md-12">
                  ...
                  <input type="tel" class="number col-md-8 service_price" name="service_price" id="service_price" placeholder="<?php echo e(__('lang.service_price')); ?>" value="<?php echo e((old('service_price')) ?  old('service_price') :''); ?>" tabindex="7">
...
<?php echo $__env->make('Front.layout.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\tijara\resources\views/Front/Services/create.blade.php ENDPATH**/ ?>