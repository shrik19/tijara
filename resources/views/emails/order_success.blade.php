      ...
      <td><table width="100%" border="0" cellspacing="0" cellpadding="0" style="max-width:630px; margin:0 auto; padding:0 15px;">
          <tbody>
           ...
           <tr>
              ...
              <tr>
                <td style="text-align:center;"><p style="margin:17px 0 35px 0;font-weight:600;color:#03989e;">Din beställning har lyckats. Nedan är länken för att kontrollera din beställning. </p></td>
              </tr>
              <tr>
