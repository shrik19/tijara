<li  class="col-xs-15">
  <div class="product_data" product_link="<?php echo e($product->product_link); ?>" <?php if($product->is_sold == '1'): ?> style="pointer-events: none;opacity: 0.4;"  <?php endif; ?>>
    <div class="product_img" style="min-height:280px;margin-bottom:20px;display:inline-block;background-color: white;">
      ...
      <div class="buy_now_hover_details">
          <ul>
              ...
              <li><a href="javascript:void(0);" <?php if(Auth::guard('user')->id()): ?> onclick="addToWishlist('<?php echo e($product->variant_id); ?>');event.stopPropagation();" <?php else: ?> onclick="showErrorMessage('<?php echo e(trans('errors.login_buyer_required')); ?>','<?php echo e(route('frontLogin')); ?>');event.stopPropagation();" <?php endif; ?>><i class="far fa-heart"></i></a></li>
          </ul>
      </div>
    </div>
    <div class="product_info">
      ...
      $product_cat_link= url('/').'/products/'.$category_name; ?>
        ...
        <a href="<?php echo e($product_cat_link); ?>">
          <h5><?php echo e($product->category_name); ?></h5></a>
          <a href="<?php echo e($product->product_link); ?>" title="<?php echo e($product->title); ?>"><h4><?php echo substr($product->title, 0, 50) ?></h4></a>
         <?php if(Request::segment(1) !='product' && Request::segment(1) !='products' && Request::segment(1) != 'get_product_listing'): ?>
        <div class="star-rating" style="font-size:unset;">
          <select class='rating product_rating' id='rating_<?php echo e($product->id); ?>' data-id='rating_<?php echo e($product->id); ?>' data-rating='<?php echo e($product->rating); ?>'>
            <option value="1" >1</option>
            <option value="2" >2</option>
