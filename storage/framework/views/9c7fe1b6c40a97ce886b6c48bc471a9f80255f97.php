<!-- <div class="ft_top_container container-fluid">
    ...
    <div class="ft_middle_container container-fluid">
      <div class="container container-inner-section ">
        ...
        <div class="col-md-3">
          ...
          <?php if(!empty($siteDetails->footer_logo)): ?>
            <img class="footer_logo"  src="<?php echo e(url('/')); ?>/uploads/Images/<?php echo e($siteDetails->footer_logo); ?>"     height="50px" />
            <?php endif; ?>
            ...
            <ul class="social_icon">
              <li><a target="_blank" href="<?php echo e(env('FACEBOOK_LINK')); ?>"><img src="<?php echo e(url('/')); ?>/assets/img/facebook_1.png"/></a></li>
              <!-- <li><a href="#"><img src="<?php echo e(url('/')); ?>/assets/front/img/tw_icon.png"/></a></li> -->
              <li><a target="_blank" href="<?php echo e(env('INSTAGRAM_LINK')); ?>"><img src="<?php echo e(url('/')); ?>/assets/img/instagram_1.png"/></a></li>
              <li><a target="_blank" href="<?php echo e(env('LINKDIN_LINK')); ?>"><img src="<?php echo e(url('/')); ?>/assets/img/link_1.png"/></a></li>
            </ul>
        </div>
        <?php
		...
		<div class="col-md-2">
           ...
           <?php if(!empty($getHowToSellPage)): ?>
              ...
              ?>
              <li><a href="<?php echo e($howToSellUrl); ?>"><?php echo e($howToSellPage); ?> </a></li>
           <?php endif; ?>
					<li><a  href="<?php echo e(route('seller_register')); ?>" ><?php echo e(__('users.footer_open_a_shop_link')); ?></a></li>
					<li><a style="cursor: pointer;" <?php if(Auth::guard('user')->id() && Auth::guard('user')->getUser()->role_id==2): ?> href="<?php echo e(route('frontDashboard')); ?>" <?php else: ?> href="<?php echo e(route('frontLoginSeller')); ?>"  <?php endif; ?>><?php echo e(__('users.footer_my_pages_link')); ?></a></li>
        ...
        <div class="col-md-2">
          <div class="ft_page_links footer-pa">
          <h3><?php echo e(__('lang.about_tijara_label')); ?></h3>
      ...
      <div class="col-md-2">
        <div class="ft_page_links footer-pa">
        <h3><?php echo e(__('lang.customer_service_label')); ?></h3>
        <ul>
         <!--  <li><a href="<?php echo e(route('frontUserProfile')); ?>"><?php echo e(__('lang.my_account_title')); ?></a></li> 
          <li><a href="javascript:void(0)"><?php echo e(__('lang.contact_us_label')); ?> </a></li>-->
        
          <?php if(!empty($getCustomerServicePage)): ?>
             <?php $__currentLoopData = $getCustomerServicePage; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $CustomerServicePage): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php
                $pageFaq = '';
                $faqUrl  = '';
                if(Config::get('app.locale') == 'se')
            ...
            ?>
            <li><a href="<?php echo e($faqUrl); ?>"><?php echo e($pageFaq); ?> </a></li>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
          <?php endif; ?>
    ...
    <div class="ft_payment_container container-fluid">
        <div class="container-inner-section">
          ...
          <img class="img-fluid" src="<?php echo e(url('/')); ?>/assets/front/img/tijara_front/footer_payment_option.png" style="padding-left: 10px;">
    ...
    <div class="clearfix"></div>
      <div class="ft_copyright">
        ...
        <p><?php echo e($siteDetails->copyright_content); ?>  </p>
      </div>
    </footer>
...
var please_check_swish_number = "<?php echo e(__('errors.please_check_swish_checkbox')); ?>";
var review_add_msg = "<?php echo e(__('messages.review_add_msg')); ?>";
var you_need_buyer_profile = "<?php echo e(__('users.you_need_buyer_profile')); ?>";
...
<?php /**PATH C:\wamp64\www\tijara\resources\views/Front/layout/footer.blade.php ENDPATH**/ ?>