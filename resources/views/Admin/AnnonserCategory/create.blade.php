...
<div class="section-body">
  ...
  <p class="section-lead">{{ __('users.add_annonser_cat_details_info')}}</p>
  ...
  <div class="row">
    <div class="col-12 col-md-8 col-lg-8">
      <div class="card">
        <div class="card-body">
          <!-- form start -->
          <form class="form-horizontal" method="post" name="frmCreateActivity" id="frmCreateActivity" action="{{route('adminAnnonserCatStore')}}" >
            {{ csrf_field() }}
