                      ...
                      <p style="margin-top: 20px;">
                        ...
                        <div class="row">
                          ...
                          <!-- <a href="javascript:void(0);"  data-toggle="modal" data-target="#bookServiceModal" 
                           ...
                           <a href="javascript:void(0);" data-toggle="modal" data-target="#bookServiceModal"  class="btn sub_btn" style="padding: 5px;margin-left: 1px;font-size: 20px;" title="{{ __('users.see_available_time_btn')}}" id="reset_option">{{ __('users.see_available_time_btn')}}<i class="far fa-calendar-alt" style="margin-left: 10px;font-size: 20px;"></i></a>
                         </div>
                        </div>
