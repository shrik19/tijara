...
class UserMain extends Model
{
    ...
    protected $fillable = ['role_id','fname','lname','email','paypal_email','phone_number','address','store_name','city','swish_number','postcode','profile','description','where_find_us','is_verified','free_shipping','shipping_method','shipping_charges','klarna_username','klarna_password','is_featured','card_fname','card_lname','card_number','card_exp_date','card_security_code'];
