...
<div class="container-fluid">
	...
	<div class="row">
		<div class="login_container">
          ...
          <a href="<?php echo e(url('/')); ?>"><img src="<?php echo e(url('/')); ?>/uploads/Images/tijara-image.png" /></a>
					</div> 
					</div>
				<?php endif; ?>
				<?php if(Request::segment(2)=='seller'): ?>
					<div class="login_banner" style="background-image: url(<?php echo e(url('/')); ?>/uploads/Banner/<?php echo e($banner->image); ?>);">
						<div class="login_banner-header">
							<h1>Sveriges första kulturella marknadsplats</h1>
						</div>
						<div class="login_banner-footer text-right">
...
</html><?php /**PATH D:\xampp\htdocs\tijara\resources\views/Front/login.blade.php ENDPATH**/ ?>