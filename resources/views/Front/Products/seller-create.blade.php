        ...
        <div class="login_box">
            ...
            <div class="form-group ">
              ...
              <div class="col-md-8">
                  ...
                  <textarea class="ge_input product_description col-md-8 " style="width:100%; height: 175px;line-height:normal !important;" name="description"  placeholder="{{ __('users.service_description_placeholder')}}" value="" tabindex="2">{{old('description')}}</textarea>
