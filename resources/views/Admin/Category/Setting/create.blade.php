        ...
        <div class="card-body">
          ...
          <form class="form-horizontal" method="post" name="frmCreateActivity" id="frmCreateActivity" action="{{route('adminSettingStore')}}" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="site_title" name="site_title" placeholder="Site Title" value="{{ old('site_title') }}" />
            ...
            <div class="form-group">
              ...
              <textarea class="form-control description" name="footer_address" id="footer_address" spellcheck="true" value="{{old('footer_address')}}"></textarea>
              <div class="text-danger">{{ ($errors->has('footer_address')) ? $errors->first('footer_address') : '' }}</div>
            </div>
            
            <div class="form-group">
              <label>Upload Header Logo  <span class="text-danger">*</span></label>
            ...
            <div class="form-group">
              <label>Upload Footer Logo  <span class="text-danger">*</span></label>
