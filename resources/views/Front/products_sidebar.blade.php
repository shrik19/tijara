...
<div class="category_list_box"  id="accordion">
        ...
        if($category_slug==$Category['category_slug'])
         ...
         @endphp
                ...
                <li class="expandCollapseSubcategory <?php echo $cls; ?>" data-toggle="collapse" data-parent="#accordion" href="#subcategories<?php echo $i; ?>" aria-expanded="true" aria-controls="collapseOne"><a href="#" id="main_cat_name<?php echo $i; ?>">{{$Category['category_name']}} <span style="float: right;" id="productCount_{{$i}}"></span></a></li>
