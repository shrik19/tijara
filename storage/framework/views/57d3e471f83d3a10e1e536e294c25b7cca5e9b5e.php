      ...
      <div class="col-md-6 pl-0">
        ...
        <div class="login_box">
            ...
            <div class="form-group">
              <label class="label_css"><?php echo e(__('users.first_name_label')); ?> <span class="de_col"></span></label>
              <input type="text" class="form-control login_input input_box_css" name="fname" id="fname" placeholder="<?php echo e(__('users.first_name_label')); ?>" value="<?php echo e((old('fname')) ?  old('fname') : $buyerDetails[0]->fname); ?>">
              <span class="invalid-feedback" id="err_fname" ><?php if($errors->has('fname')): ?> <?php echo e($errors->first('fname')); ?><?php endif; ?> </span>
            </div>

            <div class="form-group" style="margin-top: 25px;">
              <label  class="label_css"><?php echo e(__('users.last_name_label')); ?> <span class="de_col"></span></label>
              <input type="text" class="form-control login_input input_box_css" name="lname" id="lname" placeholder="<?php echo e(__('users.last_name_label')); ?>" value="<?php echo e((old('lname')) ?  old('lname') : $buyerDetails[0]->lname); ?>">
              <span class="invalid-feedback" id="err_lname" ><?php if($errors->has('lname')): ?> <?php echo e($errors->first('lname')); ?><?php endif; ?></span>
            </div>

            <div class="form-group" style="margin-top: 25px;">
              <label  class="label_css"><?php echo e(__('users.email_label')); ?> <span class="de_col">*</span></label>
              <input type="email" class="form-control login_input input_box_css" name="email" id="email" placeholder="<?php echo e(__('users.email_label')); ?>" value="<?php echo e((old('email')) ? old('email') : $buyerDetails[0]->email); ?>">
            ...
            */?>
            <div class="form-group">
              <label  class="label_css"><?php echo e(__('users.address_label')); ?> <span class="de_col"></span></label>
                <textarea class="form-control input_box_css" id="address" name="address" rows="5" cols="30" style="height:auto" tabindex="5" placeholder="<?php echo e(__('users.address_label')); ?>"><?php if(!empty($buyerDetails[0]->address)){ echo $buyerDetails[0]->address; }?></textarea>
              <span class="invalid-feedback" id="err_address"><?php if($errors->has('address')): ?> <?php echo e($errors->first('address')); ?><?php endif; ?></span>
            </div>

            <div class="form-group">
              <label  class="label_css"><?php echo e(__('users.postal_code_label')); ?> <span class="de_col"></span></label>
              <input type="text" class="form-control login_input input_box_css" name="postcode" id="postcode" placeholder="<?php echo e(__('users.postal_code_label')); ?>" value="<?php echo e((old('postcode')) ? old('postcode') : $buyerDetails[0]->postcode); ?>">
              <span class="invalid-feedback" id="err_address"><?php if($errors->has('postcode')): ?> <?php echo e($errors->first('postcode')); ?><?php endif; ?></span>
            </div>

            <div class="form-group">
              <label  class="label_css"><?php echo e(__('users.location_label')); ?> <span class="de_col"></span></label>
              <input type="text" class="form-control login_input input_box_css" name="city" id="city" placeholder="<?php echo e(__('users.location_label')); ?>" value="<?php echo e((old('city')) ? old('city') : $buyerDetails[0]->city); ?>">
       ...
       <div class="col-md-6 pr-0">
        ...
        <div class="login_box">
          ...
          <div class="form-group increment cloned">
            <label  class="label_css"><?php echo e(__('users.select_profile_picture')); ?></label>
       <!--      <?php
          ...
          <div class="col-md-4 existing-images">
            ...
            <button class="uploadbtn buyer_profile_update_btn"><i class="fa fa-upload" aria-hidden="true" style=""></i> <span><?php echo e(__('users.upload_file_input')); ?></span>
            <input type="file" name="profile" class="form-control " id="buyer_profile_image" value="<?php echo e(old('profile')); ?>"   style="cursor: pointer;" /></button>
            </div>
            ...
            <div class="form-group">
              <label  class="label_css"><?php echo e(__('users.where_did_you_find_us_label')); ?> </label>
              <input type="text" class="form-control login_input input_box_css" name="find_us" id="find_us" placeholder="<?php echo e(__('users.where_did_you_find_us_label')); ?>" value="<?php echo e((old('where_find_us')) ? old('where_find_us') : $buyerDetails[0]->where_find_us); ?>">
...
$('body').on('click', '.remove_image', function () {
    ...
    $.ajax({
          headers : {'X-CSRF-Token': $('input[name="_token"]').val()},
            url: "<?php echo e(url('/')); ?>"+'/remove-buyer-profile?image_path='+Filename,
            type: 'post',
            data: {},
...
<?php echo $__env->make('Front.layout.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wamp64\www\tijara\resources\views/Front/buyer_profile.blade.php ENDPATH**/ ?>